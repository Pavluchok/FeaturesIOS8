...
- (IBAction)changeBlurStyle:(id)sender
{
    ...
    UIVisualEffectView *blurView = [[UIVisualEffectView alloc] initWithEffect:[UIBlurEffect effectWithStyle:[segment selectedSegmentIndex]]];
    [blurView setFrame:_blurView.frame];
